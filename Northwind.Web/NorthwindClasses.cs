...
namespace Northwind
{
	...
	[DataContract] public abstract class NorthwindObject 
...
namespace Northwind
{	
	[DataContract] public partial class Product : NorthwindObject
	...
	{		[DataMember]public System.Nullable<System.Int32> ID { get; set; }	
			...
			[DataMember]public Byte[] RowTimeStamps { get; set; }	
...
{
	[DataContract]
	public partial class Customer : NorthwindObject
...
{
	[DataContract]
	public partial class Shipper : NorthwindObject
	{ 
	//		[DataMember]public System.Nullable<System.Int32> ID { get; set; }	
	//        [DataMember]public System.String Name { get; set; }	
			//[DataMember]public Northwind.SL.Security.SecureString SecureName { get; set; }	
...
{
	[DataContract]
	public partial class Supplier : NorthwindObject 
	{				
			[DataMember]public System.String ContactName { get; set; }	
			[DataMember]public System.String ContactTitle { get; set; }	
			[DataMember]public System.String Address { get; set; }	
...
{	
	...
	{		[DataMember]public System.Nullable<System.Int32> ID { get; set; }	
			...
			[DataMember]public Byte[] Pictures { get; set; }	
			[DataMember]public Byte[] RowTimeStamps { get; set; }	
			[DataMember]public System.Collections.Generic.List<Northwind.Product> Products { get; set; }	
...
namespace Northwind
{	
	[DataContract] public partial class Order : NorthwindObject
	...
	{		[DataMember]public System.Int32 ID { get; set; }	
			...
			[DataMember]public Byte[] RowTimeStamp { get; set; }	
